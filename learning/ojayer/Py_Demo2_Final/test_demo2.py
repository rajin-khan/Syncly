...
dropbox_service1 = Dropbox(token_dir="tokens", app_key="w84emdpux17qpnj", app_secret="x6ce7dtmj51xqc7")
drive_manager.add_drive(dropbox_service1,bucket_number=4)

dropbox_service2 = Dropbox(token_dir="tokens", app_key="w84emdpux17qpnj", app_secret="x6ce7dtmj51xqc7")
...
if not sorted_buckets:
    ...
    try:
        if isinstance(best_bucket, Dropbox):
